 ...
 *     total         : 2400,
 *     paymentMethod : 'Cash',
 *     settings      : { hotelName, reportTagline, currencySymbol, website, address, phone }
 *   })
 *
...
function buildReceiptHTML({
  ...
  // Dynamic settings (can be overridden or use defaults)
  const hotelName = settings?.hotelName || 'SENARI CHINESE HOTEL'
